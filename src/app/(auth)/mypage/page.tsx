    ...
    <div className="container mx-auto bg-background px-4 py-8">
      ...
      <Card className="border border-border bg-card p-6 shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-medium text-foreground">학습 환경 설정</h3>
              <p className="text-sm text-muted-foreground">알림, 퀴즈 난이도, 학습 목표 등을 설정합니다</p>
            </div>
            <Button
              variant="outline"
              asChild
              className="border-border bg-card text-foreground hover:bg-muted hover:text-foreground"
            >
              <Link href="/mypage/study-settings">설정</Link>
            </Button>
          </div>
        </div>
      </Card>
